...
Adapted to this branch: data access is over Supabase/PostgREST (the DuckDB shim
in local dev) and the LLM is Groq with a deterministic fallback — matching how
the scoring and intake agents work here.
"""
